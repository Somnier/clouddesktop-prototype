...
function page(){
  ...
  <div class="dir-grid">
    ...
    <!-- ═══ 测试流程：教室接管与部署 ═══ -->
    <div class="dir-card">
      <h3>测试流程 B：教室接管与部署</h3>
      <p>首页 → 进入教室管理 → 接管教室 → 工作台 → 部署流程(4步) → 释放管理</p>
      <div class="dir-btn-group">
        <button class="dir-btn" data-act="go-home">首页</button>
        <button class="dir-btn" data-act="open-takeover">进入教室管理</button>
        <button class="dir-btn" data-act="confirm-takeover">确认接管</button>
        <button class="dir-btn" data-act="return-workbench">工作台</button>
      </div>
      <h4>部署流程步骤</h4>
      <div class="dir-btn-group">
        <button class="dir-btn" data-act="open-deployment">进入部署</button>
        <button class="dir-btn" data-deploy-step="0">步骤0:母机准备</button>
        <button class="dir-btn" data-deploy-step="1">步骤1:终端选择</button>
        <button class="dir-btn" data-deploy-step="2">步骤2:选择桌面</button>
        <button class="dir-btn" data-deploy-step="3">步骤3:确认信息</button>
    ...
    <div class="dir-card">
      <h3>测试流程 C：教室维护</h3>
      <p>需已部署教室。工作台 → 维护菜单 → 桌面更新/IP修改 → 分发</p>
      <div class="dir-btn-group">
        <button class="dir-btn" data-act="open-maint-menu">维护菜单</button>
        <button class="dir-btn" data-act="open-maint-desktop-update">桌面更新</button>
